    ...
    structuredFunctions = [
        {
            ...
            "function": {
                ...
                -> In the case of prompts relevant to generating MCQs, the function MUST NOT RETURN an empty list as the value to the key 'MCQs'""",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "MCQs": {
...
def getUserPrompt(amount, grade, subject, details):
    prompt = f"""
    Generate {amount} multiple-choice questions for {str(grade)}th Grade in {subject}. {details}. Provide the questions in the following format:
    [
        {{
            "Q": "This is the Question in sentence form.",
            "O": ["A1", "A2", "A3", "A4"],
...
def generateMCQs(amount, grade, subject, details):
    ...
    if isResponseFormatCorrect:
        ...
        return {"status": 400, "error": "bad response format"}
...
if __name__ == "__main__":
    print(generateMCQs(4, 12, "Computer Science", "Related to Object Oriented Programming and Java Programming Language."))
